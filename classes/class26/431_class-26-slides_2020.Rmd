...
1. We'll visit Tomas Westlake's work at \color{red}{https://r-mageddon.netlify.com/post/reanimating-the-datasaurus/}
...
- Analysis F. Create and analyze a 2x2xM table, where $2 \leq M \leq 5$
  - Well, you'd have to work for it a bit, but ...

Analyses D-F are more commonly thought about in the context of generalized linear models, as we'll see in 432.
...
See the post-class page. More details as I develop them. 
