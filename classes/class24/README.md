...
2. Status report on Project B Study 2 Data Plans (due today at noon) [can be found here](https://github.com/THOMASELOVE/431-2020/blob/master/projects/projectB/study2-dataplan-status.md). **PLEASE CHECK THIS NOW TO BE SURE I HAVE YOUR DETAILS CORRECTLY LISTED. IF NOT, EMAIL ME NOW.**
...
2. Your Project B [Study 2 Data Plan](https://thomaselove.github.io/431-2020-projectB/your5.html), if not already approved. 
    - Please make sure that you've [checked the status report] and you agree with my listing of your work there. If not, email me, now.
