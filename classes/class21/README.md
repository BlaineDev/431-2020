...
1. The [Lab 06 Answer Sketch and Grading Rubric](https://github.com/THOMASELOVE/431-2020/blob/master/labs/lab06/README.md) is now available.
2. The [Course Notes](https://thomaselove.github.io/431-notes/) will get a substantial update once the grades for Project A are available and the materials for Project B are complete.
    - Coming are chapters on comparing proportions (from Classes 19-20, especially), power and sample size considerations (today's materials), and the regression material we will discuss in Classes 22-24. I certainly hope to get all of that done before Thanksgiving Break.
3. [Instructions for Project B](https://thomaselove.github.io/431-2020-projectB/) are now available.
...
4. On 2020-12-04, the San Francisco chapter of the American Statistical Association is hosting a pair of keynote speakers and a panel discussion on [A Positive Outlook During the Covid Era: how statistics could contribute to a better 2021](http://www.sfasa.org/Dec42020mtg.html). Registration is [free and required](https://www.eventbrite.com/e/2020-sfasa-holiday-celebration-tickets-127577564931), if you are interested.
5. The [ggplot2 book](https://ggplot2-book.org/) by Hadley Wickham, Danielle Navarro, and Thomas Lin Pedersen is ramping up its third edition. If you're looking for a cookbook, though, I'd recommend the [R Graphics Cookbook](https://r-graphics.org/) by Winston Chang.
6. [Explore your activity on Google with R](https://towardsdatascience.com/explore-your-activity-on-google-with-r-how-to-analyze-and-visualize-your-search-history-1fb74e5fb2b6) is an interesting piece posted 2020-11-06 by Saul Beuntello at [Towards Data Science](https://towardsdatascience.com/). 
7. You may be interested in learning about a [Github Workflow for Data Science Project Proposals](http://www.citizen-statistician.org/2020/11/github-workflow-for-data-science-project-proposals/) written by Mine Cetinkaya-Rundel, which is something I will be considering for my Spring courses.
...
All materials for this class must be in to Dr. Love by the deadlines above in order for him to complete all grading in a timely fashion. **Work that is due after 2020-12-01 that is submitted more than an hour late will be a big problem for Dr. Love. Please leave enough time to avoid that situation.**
