...
- A Type II error means we conclude this treament is not helpful, when it actually is.
...
## Partitioning the 428 Complete Cases
...
- If you have more than 4-5 predictors, it's usually necessary to split this up into two or more scatterplot matrices.
- I'd always put the outcome first in my selection here, so that things turn up on 
