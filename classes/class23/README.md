...
5. Need to pull the coefficients from a regression equation out of an R model to present the equation? Try the [equatiomatic package](https://github.com/datalorax/equatiomatic). 
    - Thanks to Davis Weaver for this suggestion.
