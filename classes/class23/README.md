...
5. In response to a Piazza question (@347), I provided lots of links to information about the NHANES 2017-18 data. If you're planning to use that data, you should be looking at those links.
    - In particular, you should look at the Doc file (next to the Data file) for each of the different groups of variables you are considering (Demographics, Dietary, Examination, Laboratory or Questionnaire.) For instance, [here is the page about 2017-18 Demographics that includes the link to the Doc file and the Data](https://wwwn.cdc.gov/nchs/nhanes/search/datapage.aspx?Component=Demographics&CycleBeginYear=2017), and [here's what you get when you go to that Doc file link](https://wwwn.cdc.gov/Nchs/Nhanes/2017-2018/DEMO_J.htm) on Demographics in 2017-18.
