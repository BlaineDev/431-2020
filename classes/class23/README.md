...
5. Need to pull the coefficients from a regression equation out of an R model to present the equation? Try the [equatiomatic package](https://github.com/datalorax/equatiomatic). Thanks to Davis Weaver for this suggestion.
6. This Friday 2020-11-20 from 10 AM to 1 PM is the Virtual Public Health Innovations Conference sponored by the MPH program at CWRU, and open to all. [This pdf flyer](https://github.com/THOMASELOVE/431-2020/blob/master/classes/class23/Fall%202020%20Innovations%20full%20agenda.pdf) has all of the information.
