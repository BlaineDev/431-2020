...
5. Need to pull the coefficients from a regression equation out of an R model to present the equation? Davis Weaver was good enough to suggest the [equatiomatic package](https://github.com/datalorax/equatiomatic). 
