---
title: "431 Project B Study 2 Demonstration"
...
This document demonstrates analyses we are asking you to complete in Study 2 for Project B (using your data.) The simulated data used in this demo project are found in the `hbp_study.csv` data file available on [our 431-data website](https://github.com/THOMASELOVE/431-data).
...
**Note**: Please pay careful attention to the revised instructions for Section 3 (Cleaning the Data) posted in the [Study 2 Report Specifications](https://thomaselove.github.io/431-2020-projectB/your6.html). This demonstration project was built prior to the creation of those instructions, and so does not follow them precisely. 
...
**Note**: Please pay careful attention to the revised instructions for Section 5 (My Final Variables) posted in the [Study 2 Report Specifications](https://thomaselove.github.io/431-2020-projectB/your6.html). This demonstration project was built prior to the creation of those instructions, and so does not follow them precisely. 
