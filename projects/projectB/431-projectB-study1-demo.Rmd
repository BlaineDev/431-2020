...
- Here, I've assumed a two-sided confidence interval procedure. We conclude from the confidence interval (which contains zero) that there is no statistically detectable difference between the true locations of the English and non-English `bmi` levels at the 10% significance level.
...
End your report with the session information, in its own section.
